...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("MovimentDetailObjectPageObjectPage journey");

        opaTest("Navigate to MovimentDetailObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheMovimentByWarehouseObjectPage.onTable({ property: "details" }).iCheckRows();
            When.onTheMovimentByWarehouseObjectPage.onTable({ property: "details" }).iPressRow(0);

            Then.onTheMovimentDetailObjectPage.iSeeThisPage();
        });
